...
public class DeliveryReceipt {
	...
	/**
	 * Validation method to guarantee that an err value passed in is valid by smpp
	 * 3.4 spec
	 * 
	 * @param errorCode
	 * @return
	...
	/**
	 * Parses the text of the short message and creates a DeliveryReceipt from the
